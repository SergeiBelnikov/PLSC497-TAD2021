...
"Original model (p=0.8)
Baseline Accuracy:  0.6502463 
SVM-Linear Accuracy: 0.7721675 
SVM-Radial Accuracy: 0.6724138"

# The accuracy of the prediction went up

"New model (p=0.3)
Baseline Accuracy:  0.6631505 
SVM-Linear Accuracy: 0.7457806 
SVM-Radial Accuracy: 0.6631505"
...
set.seed(1984)
ids_train <- createDataPartition(1:nrow(news_dfm), p = 0.3, list = FALSE, times = 1)
