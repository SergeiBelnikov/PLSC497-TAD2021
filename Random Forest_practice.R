...
news_dfm <- dfm(news_samp$text, remove_punct = TRUE) %>% convert("matrix")
...
##I kept stopwords and avoided stemming, therefore, I significantly increased the number of features.The imaginary fitted line on the importance plot should become less steep.
## Also, I expect some of the stopwords to appear on the plot.
